export const translations = {
    en: {
        ...
        accountDetailsPage: {
            ...
            uploadFailedMsg: 'Please try again.',
            missingName: 'Missing name',
            missingNameMsg: 'Please enter a display name.',
            permissionRequired: 'Permission required',
            permissionMsg: 'Please allow photo library access to upload a profile photo.',
            notConfigured: 'Cloudinary not configured',
            configMsg: 'Set EXPO_PUBLIC_CLOUDINARY_CLOUD_NAME and EXPO_PUBLIC_CLOUDINARY_UPLOAD_PRESET in your environment.',
        ...
        route: {
            ...
            loadingPlaces: 'Wait a moment, we are still loading places near you...',
    ...
    he: {
        ...
        accountDetailsPage: {
            ...
            photoSuccess: 'תמונת הפרופיל עודכנה בהצלחה!',
            error: 'לא ניתן היה לעדכן את הפרופיל. אנא נסה שוב.',
            uploadFailed: 'העלאה נכשלה',
            uploadFailedMsg: 'אנא נסה שוב.',
            missingName: 'שם חסר',
            missingNameMsg: 'אנא הזן שם תצוגה.',
            permissionRequired: 'נדרשת הרשאה',
            permissionMsg: 'אנא אפשר גישה לספריית התמונות כדי להעלות תמונת פרופיל.',
            notConfigured: 'Cloudinary לא מוגדר',
            configMsg: 'הגדר את EXPO_PUBLIC_CLOUDINARY_CLOUD_NAME ו-EXPO_PUBLIC_CLOUDINARY_UPLOAD_PRESET בסביבת העבודה שלך.',
            readError: 'לא ניתן היה לקרוא את התמונה שנבחרה.',
        },
        placesSection: {
        ...
        route: {
            ...
            loadingPlaces: 'חכה רגע, אנחנו עדיין טוענים מקומות בקרבתך...',
